...
@Component({
  selector: 'app-modify-theme',
  templateUrl: './modify-theme.component.html',
  styleUrls: ['./modify-theme.component.scss']
})
export class ModifyThemeComponent implements OnInit {
